...
(/usr/bin/crontab -u $(/usr/bin/whoami) -l; /usr/bin/echo "${UPDATE_4AM}" )| /usr/bin/crontab -u $(/usr/bin/whoami) -
(/usr/bin/crontab -u $(/usr/bin/whoami) -l; /usr/bin/echo "${UPDATE_AT_REBOOT}") | /usr/bin/crontab -u $(/usr/bin/whoami) -
(/usr/bin/crontab -u $(/usr/bin/whoami) -l; /usr/bin/echo "${MONITOR_CRON}") | /usr/bin/crontab -u $(/usr/bin/whoami) -
